            ...
            <div className="relative min-h-[320px] sm:min-h-[360px]">
              ...
              <div className="relative z-10 flex h-full items-end p-7 sm:p-9">
                <div className="max-w-sm">
                  ...
                  <h3 className="mt-4 font-display text-3xl font-black tracking-tight text-white sm:text-4xl">
                    {promo.title}
                  </h3>
                  <p className="mt-3 text-sm text-white/78 sm:text-base">{promo.subtitle}</p>
                  <Link
                    href={promo.href}
