      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section className="mt-12 grid gap-5 md:grid-cols-2">
          {pillars.map((pillar) => (
            <article
              key={pillar.title}
              className="rounded-[2rem] border border-border bg-card p-6 shadow-[0_18px_40px_rgba(15,23,42,0.05)]"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-500/10 text-brand-500">
                <pillar.icon className="h-6 w-6" />
              </div>
              <h2 className="mt-5 text-2xl font-black tracking-tight">{pillar.title}</h2>
